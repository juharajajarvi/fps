...
function Update () 
{
    ...
    var angle : float = Vector3.Angle(
    	buttonTransform.position - cameraTransform.position, 
    	buttonTransform.position + (cameraTransform.right * buttonTransform.localScale.magnitude) - cameraTransform.position
	);
